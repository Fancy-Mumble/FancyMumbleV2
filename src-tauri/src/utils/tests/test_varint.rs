...
mod tests {
    ...
    fn test_64bit_positive_integer() {
        assert_eq!(
            ...
            Builder::from(
                vec![0xF7, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF].as_slice()
            )
            .build()
            .unwrap()
            .parsed_pair()
        ...
        assert_eq!(
            (0xFFFF_FFFF_FFFF_FFFF, 9),
            Builder::from(
                vec![0xF6, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF].as_slice()
            )
            .build()
            .unwrap()
            .parsed_pair()
        ...
        assert_eq!(
            (0xFFFF_FFFF_FFFF_FFFF, 9),
            Builder::from(
                vec![0xF5, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF].as_slice()
            )
            .build()
            .unwrap()
            .parsed_pair()
        ...
        assert_eq!(
            (0xFFFF_FFFF_FFFF_FFFF, 9),
            Builder::from(
                vec![0xF4, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF].as_slice()
            )
            .build()
            .unwrap()
            .parsed_pair()
    ...
    fn test_invalid_varint() {
        assert_eq!(
            true,
            Builder::from(vec![].as_slice()).build().is_err()
        );
        assert_eq!(
            true,
            Builder::from(vec![0xBF].as_slice()).build().is_err()
        );
        assert_eq!(
            true,
            Builder::from(vec![0xDF, 0xFF].as_slice())
                .build()
                .is_err()
        );
        assert_eq!(
